-- =============================================================
-- AirPulse – Smart Pollution Analytics Database Schema
-- DBMS Target: MySQL / MariaDB (XAMPP / WAMP Compatible)
-- Purpose: College DBMS Course Project Submission
-- =============================================================
...
(6, 1, '2026-06-11 10:00:00', 22.00, 35.00, 0.48, 28.00, 4.20, 34.00, 33, 'Good'),
(7, 2, '2026-06-11 10:00:00', 36.00, 55.00, 0.65, 42.00, 8.50, 26.00, 54, 'Moderate'),
(8, 3, '2026-06-11 10:00:00', 14.00, 22.00, 0.32, 18.00, 3.00, 42.00, 21, 'Good'),
(9, 4, '2026-06-11 10:00:00', 165.00, 280.00, 2.45, 92.00, 21.00, 50.00, 247, 'Severe'),
(10, 5, '2026-06-11 10:00:00', 9.00, 16.00, 0.20, 11.00, 2.00, 31.00, 13, 'Good'),
(11, 4, '2026-06-12 10:00:00', 180.00, 310.00, 2.80, 110.00, 25.00, 55.00, 270, 'Severe');

-- Insert some static alerts
INSERT INTO SystemAlerts (StationID, RecordID, Pollutant, ObservedValue, ThresholdValue, AlertTimestamp)
VALUES 
(4, 4, 'AQI', 217.00, 200.00, '2026-06-10 10:00:00'),
(4, 9, 'AQI', 247.00, 200.00, '2026-06-11 10:00:00'),
(4, 11, 'AQI', 270.00, 200.00, '2026-06-12 10:00:00');

-- Insert historical audit operations logs
INSERT INTO AuditLog (ActionType, TableName, RecordID, NewValues, ActionTimestamp)
VALUES 
('INSERT', 'Stations', 1, '{"Name":"Central Park Observatory","City":"New York"}', '2020-01-15 09:00:00'),
('INSERT', 'Stations', 2, '{"Name":"Westminster Station","City":"London"}', '2021-03-22 09:00:00'),
('INSERT', 'Stations', 3, '{"Name":"Shinjuku Station South","City":"Tokyo"}', '2019-11-01 09:00:00'),
('INSERT', 'Stations', 4, '{"Name":"Connaught Place Metro","City":"Delhi"}', '2018-05-12 09:00:00'),
('INSERT', 'Stations', 5, '{"Name":"Circular Quay Terminal","City":"Sydney"}', '2022-08-30 09:00:00');
